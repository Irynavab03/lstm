...
#joblib.dump(input_scaler, 'C:\\Users\\Windows10\\OneDrive\\Dokumen\\farming Irynaak\\lstm\\lstm baru\\input_scaler1.pkl')
#joblib.dump(output_scaler, 'C:\\Users\\Windows10\\OneDrive\\Dokumen\\farming Irynaak\\lstm\\lstm baru\\output_scaler1.pkl')
...
# Melatih model
history = model.fit(X_train, y_train, epochs=200, batch_size=25, validation_data=(X_test, y_test), callbacks=[early_stopping], verbose=1)

# Menyimpan model yang telah dilatih
#model.save('C:\\Users\\Windows10\\OneDrive\\Dokumen\\farming Irynaak\\lstm\\lstm baru\\hujan1.h5')
#print("Model telah disimpan sebagai 'hujan.h5'")
